...
(function() {
  ...
  function mapBoothToDB(booth) {
    return {
      ...
      contact_email: booth.contactEmail,
      contact_phone: booth.contactPhone,
      contact_title: booth.contactTitle,
      contact_ext: booth.contactExt,
      contact_other: booth.contactOther,
      orders_per_month: booth.ordersPerMonth,
      aov: booth.aov,
      business_card_data: booth.businessCardData,
      business_card_url: booth.businessCardUrl,
      ...
      deal_record_id: booth.hsDealId || booth.dealRecordId,
